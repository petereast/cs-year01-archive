...
<c:choose>
  <c:when test="${param.submitted!=null}">
	...
	<sql:update var="count"> 
          ...
          "AA01-005",
          "The Code Book",
          "An in-depth look at the history of encoding messages, from ancient times until the very cutting edge of coding technology",
          "Simon Singh",
          "aa01-005.jpg",
          1001,
          35.89,
	...
	<sql:update var="count"> 
          ...
          "AA01-006",
          "CUDA by Example",
          "Teaches NVidia's CUDA programming language using examples.",
	...
	<sql:update var="count"> 
          ...
          "AA01-011",
          "OK Computer",
          "Undoubtedly the greatest album of all time",
          "Radiohead",
          "aa01-011.jpg",
          1002,
          9.99,
	...
	<sql:update var="count"> 
          ...
          "AA01-012",
          "Down In Albion",
          "Babyshambles' debut album about Pete Doherty being sad",
          "Babyshambles",
          "aa01-012.jpg",
          1002,
          6.79,
	...
	<sql:update var="count"> 
          ...
          "AA01-017",
          "The Last of Us",
          "Basically just zombies and emotions.",
          "Naughty Dog",
          "aa01-017.png",
          1003,
          45.99,
	...
	<sql:update var="count"> 
          ...
          "Guns, explosions, very strong English & Scottish accents and yet more emotions.",
          "Infinity Ward",
          "aa01-018.jpg",
          1003,
          19.99,
	...
	<sql:update var="count"> 
          ...
          "AA01-023",
          "28 Days Later",
          "Understated British horror, set in London.",
          "Danny Boyle",
          "aa01-023.jpg",
          1004,
          2.99,
	...
	<sql:update var="count"> 
          ...
          "AA01-024",
          "Pulp Fiction",
          "A thriller by Quentin Tarantino, need I say more?",
          "Mirmax Pictures",
          "aa01-24.png",
          1004,
          6.99,
